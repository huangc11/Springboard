...
class intgrFactTbProcessor:
    ...
    def  process_stg_dim_table(self, df_fl_base):
        ...
        *'****************************************************'''
        ...
        ut_spark.show_partition_count((df_date))
        df_date.coalesce(1).write.format("parquet").mode("append") .option("path", stg_fp).save()
        ...
        *'****************************************************'''
        ...
        df_od3.coalesce(1).write.format("parquet").mode("append").option("path", stg_fp).save()
    ...
    def generate_fact_flight(self, df_fl_base):
        ...
        ut_spark.show_partition_count(df_fact_flt)
