...
class intgrFactTbGeneration:
    ...
    @classmethod
    def cr_df_fl_base(cls):
        c_proc_name=cls.c_proc_name
        ...
        ut_log.log_proc_metric(log_id, c_proc_name, df_fl, 'read',ut_store.folder_cln + ut_store.cln_file_flight)
    ...
    def create_fact_and_dim(cls):
        ...
        df_fl_base=cls.cr_df_fl_base()
        print("df_fl_base count:")
        print(df_fl_base.count())

        print("flight_base table created.")
        #create
        try:
            ...
            *****************************************************'''
            ...
            print("creating df of origin_dest ...")
            ...
            print("saving to dim_origin_dest...")
            ...
            *****************************************************'''
            ...
            df_fact_flt_repart=df_fact_flt.repartition(cls.c_ff_num_partition, "seq_id")
           ...
           --------------------------------------------------------'''
            ...
            ut_log.log_proc_metric(ut_log.get_log_id(), c_proc_name, df3, 'write', wf_path)
